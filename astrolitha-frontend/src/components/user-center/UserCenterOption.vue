  ...
  <div class="option-root">
    <div class="card-grid">
      <el-card class="card" shadow="never">
        <div class="section-title">Astrolitha设置</div>
        <el-form label-width="7rem" class="form">
          <el-form-item label="后端IP地址">
        ...
        <el-form label-width="10rem" class="form">
          <el-form-item label="语言设置">
            <el-select v-model="userCenterOption.language" style="width: 8rem">
              <el-option label="简体中文" :value="userCenterOption.language" />
            </el-select>
          </el-form-item>
        </el-form>
      </el-card>
      <el-card class="card" shadow="never">
        <div class="section-title" style="margin-top:2rem;">集群设置</div>
        <el-form label-width="7rem" class="form">
